<template>
  <div class='PageContainer flex justify-center py-10 h-screen'>
    <div class='MessageContainer flex flex-col justify-end bg-slate-100 w-1/2 h-3/4 p-5' >
...
import { getMessages } from '../src/components/service'
